        ...
        description = new Memoizer<Description>() {
            ...
            protected Description computeValue() {
                ...
                if (isNotIgnored() && !describeFlat()) {
                    ...
                    return new ParametrizedDescription(namingStrategy, testClass.getJavaClass().getName(), name()).parametrizedDescription(parametersSets(), frameworkMethodAnnotations.allAnnotations());
                } else {
